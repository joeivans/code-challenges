<section id="top">
    ...
    <p> <em>
        ...
        else every day. If I haven't solved the challenge before, I add it to
        this repo. Some days I just do maintenance when I have nothing to add.
        </em> </p>
    <p><em>
...
<details open>
    ...
    <li>
        <a href="./js/algo-challenges/merge-sorted-array">Merge Sorted Array</a>
    </li>
    <li>
        <a href="./js/algo-challenges/minimum-consecutive-cards-to-pick-up">Minimum Consecutive Cards to Pick Up</a>
    </li>
    <li>
        <a href="./js/algo-challenges/minimum-size-subarray-sum">Minimum Size Subarray Sum</a>
    </li>
    <li>
